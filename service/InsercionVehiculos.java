...
public class InsercionVehiculos {
    ...
    public static Motocicleta insertarMotocicleta() {
        ...
        Long dniTitular = Long.parseLong(entrada.nextLine());
        ...
        // Crear la instancia
        Motocicleta moto = new Motocicleta( dniTitular, "Motocicleta", marca, modelo, anioFabricacion,
    ...
    public static Auto insertarAutomovil() {
        ...
        // Crear la instancia
        Auto nuevoAuto = new Auto(dniTitular, "Auto", marca, modelo, anioFabricacion,
    ...
    public static Camioneta insertarCamioneta() {
        ...
        // Crear la instancia
        Camioneta nuevaCamioneta = new Camioneta (dniTitular, "Auto", marca, modelo, anioFabricacion, color,
